...
# 2. POISONED DATASET 
# We added two fake rows at the end (marked below)
X_poisoned = np.array([-40, -10, 0, 8, 15, 22, 38,   30,  35]).reshape(-1, 1)
Y_poisoned = np.array([-40,  14, 32, 46.4, 59, 71.6, 100.4, -200, -500]) 
#                                                            ^     ^
#                                                    ATTACK! Fake answers!
